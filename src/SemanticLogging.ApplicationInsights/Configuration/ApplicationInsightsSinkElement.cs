...
{
    internal class ApplicationInsightsSinkElement : ISinkElement
    {
        private readonly XName sinkName = XName.Get("applicationInsightsSink", Constants.Namespace);
        ...
        public IObserver<EventEntry> CreateSink(XElement element)
        {
            ...
            return new ApplicationInsightsSink(
